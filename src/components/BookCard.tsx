  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="group bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl/20 transition-all duration-200 hover:-translate-y-3"
      >
